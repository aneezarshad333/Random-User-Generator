  ...
  return (
    <>
      <div className='w-100 d-flex justify-content-center align-itmes-center' style={{ height: '100vh'}}>
        <div>
          <h1 className='text-center mt-5' style={{fontFamily:'Roboto Slab'}}>Generate Random Users</h1>
          {user&&<div style={{ width: '600px',backgroundColor:`#${color}`,fontFamily:'Solway'}} className='border rounded p-2 mt-4 shadow'>
          ...
          <div className='d-flex justify-content-center mt-3'> <button className='btn btn-primary' onClick={fetchUser}>Generate</button></div>
        </div>
      </div>
    </>
  )
